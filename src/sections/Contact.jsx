    ...
    <section id='contact' className='c-space my-20'>
      <div className='relative min-h-screen flex justify-center items-center flex-col'>
        ...
        <div className='contact-container min-h-full'>
          ...
          <p className="text-lg text-white-600 mt-3">Whether you're building a new website, improving an existing platform or innovating something new, I'm here to help.</p>
